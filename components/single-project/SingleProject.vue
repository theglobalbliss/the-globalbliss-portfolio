    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center pb-30">
          <p>BRANDING - The GlobalBliss Brand</p>
      ...
      <div class="row pt-30">
        <div class="col-lg-6">
          <div class="single-image wow fadeInUp delay-0-2s">
            <img
              src="assets/images/projects/single-project1.jpg"
              alt="gallery"
            />
          </div>
        </div>
        <div class="col-lg-6">
          <div class="single-image wow fadeInUp delay-0-4s">
            <img
              src="assets/images/projects/single-project2.jpg"
              alt="gallery"
            />
          </div>
        </div>
        <div class="col-lg-6">
          <div class="single-image wow fadeInUp delay-0-6s">
            <img
              src="assets/images/projects/single-project3.jpg"
              alt="gallery"
            />
          </div>
        </div>
        <div class="col-lg-6">
          <div class="single-image wow fadeInUp delay-0-8s">
            <img
              src="assets/images/projects/single-project4.jpg"
              alt="gallery"
            />
          </div>
        </div>
